      ...
      <div class="col-md-12"> 
            ...
            <div class="card col-md-10 mx-auto">
              ...
              <div class="card-body">
                ...
                <form action="<?= base_url('/public/index.php/simpan_absen'); ?>" method="POST" class="row g-3">
                  
                  <!-- <div class="col-md-3">
                    <label for="exampleInputEmail1" class="form-label">Periode</label>
                    <p>Enter Date: <input type = "date" id = "datepicker"></p>
                    <div class="input-append date" id="datepicker" data-date="04-2022" data-date-format="mm-yyyy">
...
<input type="month" id="periode" name="periode" min="2022-04" required>
                  ...
                  <div class="col-md-9">
                    ...
                    <input type="text" class="form-control form-control-sm" id="nama" name="nama" readonly="" required>
                  </div>
                  ...
                  <div class="col-md-12">
                    <input type="hidden" class="form-control form-control-sm" id="jabatan2" name="jabatan2" required>
                  </div>
                  ...
                  <div class="col-md-3">
                    ...
                    <input type="number" class="form-control form-control-sm" id="masuk" name="masuk" value="0" required>
                  </div>
                  <br>
                  <div class="col-md-3">
                  ...
                  <div class="col-md-4">
                      ...
                      <input type="number" class="form-control form-control-sm" id="gaji_pokok" name="gaji_pokok" readonly="" required>
                    </div>
                  <div class="col-md-4">
                      <label for="exampleInputEmail1" class="form-label">Uang Transport</label>
                      <input type="number" class="form-control form-control-sm" id="uang_transport" name="uang_transport" readonly="" required>
                  </div>
                  <div class="col-md-4">
                      <label for="exampleInputEmail1" class="form-label">Uang Makan</label>
                      <input type="number" class="form-control form-control-sm" id="uang_makan" name="uang_makan" readonly="" required>
                  </div>
                  <div class="col-md-4">
                      <label for="exampleInputEmail1" class="form-label">Tunjangan Kawin</label>
                      <input type="number" class="form-control form-control-sm" id="tunjangan_kawin" name="tunjangan_kawin" readonly="" required>
                  </div>
                  <div class="col-md-4">
                      <label for="exampleInputEmail1" class="form-label">Potongan Alpha</label>
                      <input type="number" class="form-control form-control-sm" id="potongan_alpha" name="potongan_alpha" value="0" readonly="">
                  </div>
                  <div class="col-md-4">
                      <label for="exampleInputEmail1" class="form-label">Potongan Ijin</label>
                      <input type="number" class="form-control form-control-sm" id="potongan_ijin" name="potongan_ijin" value="0" readonly="">
                  </div>
                  <div class="col-md-4">
                      <label for="exampleInputEmail1" class="form-label">Sewa Motor</label>
                      <input type="number" class="form-control form-control-sm" id="sewa_motor" name="sewa_motor" readonly="" required>
                  </div>
                  <div class="col-md-4">
                      <label for="exampleInputEmail1" class="form-label">BPJS</label>
                      <input type="number" class="form-control form-control-sm" id="bpjs" name="bpjs" readonly="" required>
                  </div>
                  <div class="col-md-4">
                      <label for="exampleInputEmail1" class="form-label">Total Gaji</label>
                      <input type="number" class="form-control form-control-sm" id="total_gaji" name="total_gaji" readonly="" required>
                  </div>
