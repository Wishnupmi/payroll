...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">Payroll</a>
  ...
  <div class="navbar-nav">
    ...
    <?php
        ...
        //   echo $something;
          if ($something=='cari_slip') {
      ?>
      <a class="nav-link px-3" href="../../../../payroll/public/index.php/login/logout">Sign out</a>
